...
public class Pizza {
    ...
    //calculates the total price of the pizza, returns the result as double
    ...
    public void setInfo(char size, int numberOfCheeseTopping, int numberOfPepperoniTopping){
        this.size = size;
        this.numberOfCheeseTopping = numberOfPepperoniTopping;
        this.numberOfPepperoniTopping = numberOfPepperoniTopping;
    }


    //used for displaying all information for the pizza
