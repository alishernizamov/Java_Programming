...
public class Car {
    ...
    public Car(String make, String model) {
        //this.make = make; //we can call the 1st constructor instead since it setting the make, see next line
        this(make); //this.make = make;
        this.model = model;
    }

    public Car(String make, String model, int year) {
        this(make, model); //this.make = make; & this.model = model;
        this.year = year;
    }

    public Car(String make, String model, int year, double price) {
        this(make, model, year); //called the constructor that can set the make, model and year
        this.price = price;
    }
