...
public final class CydeoDevStudent extends Person { //used 'final' so this class can never be inherited

    public CydeoDevStudent(String name, char gender, LocalDate dateOfBirth, String id, String batchName, int batchNumber) {
        super(name, gender, dateOfBirth);
        if (getAge() < 18){ //if age < 18
            System.err.println("Cydeo Dev student must be at least 18 years of age");
            System.exit(1);
        }
        this.id = id;
    ...
    private final String id; //unchangeable
