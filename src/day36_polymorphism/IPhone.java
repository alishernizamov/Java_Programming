...
public class IPhone {
    ...
    @Override
    public boolean equals(Object obj) { //reference type of Object is parent

        if (!(obj instanceof IPhone)){ //if the given obj is not iphone
            ...
            if (model.equals( ( (IPhone)obj ).model)){ //if model is equal to the given iPhone's model
            /*
                if (color.equals( ( (IPhone )obj ).color )){ //if the colors are same
                    return true;
                }
             */
                return true;
