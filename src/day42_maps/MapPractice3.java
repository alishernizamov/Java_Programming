...
public class MapPractice3 {
    public static void main(String[] args) {
        ...
        //task: INCREASE SALARY OF THE 2ND PERSON by 10K
        arrayOfMap[1].replace("salary", ((Integer) arrayOfMap[1].get("salary")) + 10000); //salary of Nora changed to 100,000 from 90,000

        //task: change name of the 1st person to "Hasan"
        arrayOfMap[0].replace("name", "Hasan");

        System.out.println(Arrays.toString(arrayOfMap));

        System.out.println("---------------------------------------------------------------------");
        //task: employees show are making less than 100K
        int count = 0;
